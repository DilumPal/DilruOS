; ==================================================================
; dilruos -- An Operating System kernel written in Assembly
; by Dilum Palawaththa. This OS is inspired by MikeOS. Great thanks
...
detect_memory:
    ...
    call print_string
    int 10h             ; Returns base memory size in KB in AX
    mov [base_mem_kb], ax
    call print_decimal
    call print_k_suffix
...
welcome_string      db 'Welcome to dilruos by Dilum Palawaththa!', 0
prompt_string       db 'dilruos :) >> ', 0
